use std::future::Future;
    ...
    use windows::Win32::Networking::WinSock::{
        closesocket, getsockname, WSAGetOverlappedResult, WSAIoctl, WSASocketW, ADDRESS_FAMILY, LPFN_ACCEPTEX, SIO_GET_EXTENSION_FUNCTION_POINTER, SOCKADDR, SOCKADDR_IN, SOCKET, SOCK_STREAM, WSAID_ACCEPTEX, WSA_FLAG_NO_HANDLE_INHERIT, WSA_FLAG_OVERLAPPED, WSA_IO_INCOMPLETE, WSA_IO_PENDING
    };
    ...
    static mut ACCEPTEX: OnceLock<LPFN_ACCEPTEX> = OnceLock::new();
            ...
            unsafe fn acceptex_init(sock: SOCKET) -> LPFN_ACCEPTEX {
                ...
                {
                    panic!("Error at init of extension")
                };
